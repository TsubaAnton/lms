# Generated by Django 4.2 on 2024-05-21 17:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('Наличка', 'Cash'), ('Перевод на счет', 'Transfer')], max_length=25, verbose_name='Способ оплаты')),
